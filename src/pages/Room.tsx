//VER LIB REACT-MODAL para fazer modais de confirmacao
...
export function Room(){
    ...
    async function handleLikeQuestion(questionId: string, likeId: string | undefined){
        //se ja houver like por este usuario, fazer deslike, caso contrario, dar like
        if (likeId){
            //apagando no banco de dados
            remove(ref(getDatabase(), `rooms/${roomId}/questions/${questionId}/likes/${likeId}`));
        } else {
            //gravando no banco de dados Firebase 9
            const newLikeRef = push(ref(getDatabase(), `rooms/${roomId}/questions/${questionId}/likes`));
            set(newLikeRef, { authorId: user?.id });
        }
    }
